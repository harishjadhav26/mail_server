...
$config['des_key'] = 'dClOQRGcIg6G0Aejj4xYQszT';
...
$config['plugins'] = array('filesystem_attachments', 'identity_select', 'managesieve', 'newmail_notifier', 'password', 'virtuser_file', 'virtuser_query', 'archive', 'markasjunk', 'new_user_identity', 'show_additional_headers', 'subscriptions_option', 'vcard_attachments', 'jqueryui', 'emoticons', 'example_addressbook', 'vcard_attachments');
...
$config['addressbook_search_mods'] = array('name'=>1, 'firstname'=>1, 'surname'=>1, 'email'=>1, '*'=>1);  // Example: array('name'=>1, 'firstname'=>1, 'surname'=>1, 'email'=>1, '*'=>1);
...
$config['default_addressbook'] = true;
...
$config['virtuser_query'] = "select username from vmailadmin.mailbox where username = '%u'";
